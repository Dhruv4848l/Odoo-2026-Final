  ...
  payslips: [
    {
      ...
      status: 'Draft',
      lines: [
        { rule_id: 101, code: 'BASIC', name: 'Basic Wage', category: 'BASIC', sequence: 10, amount: 4500 },
        { rule_id: 102, code: 'HRA', name: 'House Rent Allowance', category: 'ALLOWANCE', sequence: 20, amount: 1800 },
        { rule_id: 103, code: 'TA', name: 'Transport Allowance', category: 'ALLOWANCE', sequence: 30, amount: 300 },
        { rule_id: 104, code: 'SUP_ALW', name: 'Supervisor Allowance', category: 'ALLOWANCE', sequence: 40, amount: 500 },
        { rule_id: 105, code: 'PF', name: 'Provident Fund (Capped)', category: 'DEDUCTION', sequence: 50, amount: 540 },
        { rule_id: 106, code: 'TAX', name: 'Income Tax', category: 'DEDUCTION', sequence: 60, amount: 710 },
      ],
    },
  ],
  email_logs: [] as any[],
